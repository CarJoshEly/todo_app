...
//## 5.Crea la estructura base con StatefulWidget para manejar tareas:
...
class _TodoHomePageState extends State<TodoHomePage> {
  //## 7. Remplaza _tasks con:
  final List<Task> _tasks = [];
  final TextEditingController _controller = TextEditingController();

  //## 8. Actualiza _addTask():
  void _addTask() {
...
//## 10. Ejecuta el proyecto y valida:
